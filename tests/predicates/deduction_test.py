...
from src.predicates.deduction import *
...
def test_prove_by_way_of_contradiction(debug=False):
    ...
    from src.predicates.some_proofs import COMPREHENSION_AXIOM, prove_russell_paradox
    from tests.predicates.some_proofs_test import test_prove_russell_paradox
