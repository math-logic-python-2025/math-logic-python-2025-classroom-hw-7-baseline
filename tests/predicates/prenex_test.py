...
def test_uniquely_rename_quantified_variables(debug=False):
    from src.predicates.prenex import _uniquely_rename_quantified_variables
...
def test_pull_out_quantifications_across_negation(debug=False):
    from src.predicates.prenex import _pull_out_quantifications_across_negation
...
def test_pull_out_quantifications_across_binary_operator(debug=False):
    from src.predicates.prenex import _pull_out_quantifications_across_binary_operator
...
def test_to_prenex_normal_form_from_uniquely_named_variables(debug=False):
    from src.predicates.prenex import _to_prenex_normal_form_from_uniquely_named_variables
