...
from src.propositions.semantics import is_tautology
from src.predicates.completeness import *
...
def test_replace_constant(debug=False):
    from src.predicates.some_proofs import (
        prove_syllogism,
        prove_syllogism_with_universal_instantiation,
        GROUP_AXIOMS,
        prove_group_unique_zero,
    )
    from tests.predicates.some_proofs_test import test_prove_group_unique_zero
...
def test_existential_closure_step(debug=False):
    from src.logic_utils import fresh_constant_name_generator
