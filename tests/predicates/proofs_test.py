...
from src.predicates.proofs import *
...
def test_axiom_specialization_map_to_schema_instantiation_map(debug=False):
    from src.predicates.proofs import _axiom_specialization_map_to_schema_instantiation_map
...
def test_prove_from_skeleton_proof(debug=False):
    from src.propositions.tautology import prove_tautology
    from src.predicates.proofs import _prove_from_skeleton_proof
