...
def test_synthesize_for_model(debug=False):
    from src.propositions.semantics import _synthesize_for_model

    __test_synthesize_clause(_synthesize_for_model, True, debug)


def test_synthesize_for_all_except_model(debug=False):
    from src.propositions.semantics import _synthesize_for_all_except_model
...
def test_evaluate_inference(debug=False):
    from src.propositions.proofs import InferenceRule
